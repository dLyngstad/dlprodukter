// Fil: app.js
// Versjon: Endelig med Windows-styling og Header/Footer
...
/**
 * Bygger et detaljert produktkort med Windows Classic-tema.
 */
const createProductHTML = (product) => {
    ...
    // Denne malen bruker nå .group-box for å matche din retro-stil
    return `
        <div class="group-box product-card-retro">
            <span class="group-box-legend">${product.name}</span>
            
            <div class="product-content-wrapper">
                <img src="${product.image}" alt="${product.name}" class="product-image-retro">
