...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const initializePage = () => {
        // 1. Sett opp navigasjonen UMIDDELBART
        window.addEventListener('hashchange', router);
        router();

        // 2. Oppdater UI for innlogging i bakgrunnen.
        ui.updateAuthUI().catch(error => {
            console.error("Feil under lasting av bruker-UI:", error);
        });
    };
